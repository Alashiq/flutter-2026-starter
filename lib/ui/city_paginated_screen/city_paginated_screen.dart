...
import 'package:starter/core/widgets/view/api_view_paginated.dart';
...
class CityPaginatedScreen extends GetView<CityController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('المدن مع Pagination'),
        centerTitle: true,
      ),
      body: Column(
        children: [
